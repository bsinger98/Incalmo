...
from plugins.deception.app.strategies.llm.interfaces.sonnet3_5_interface import (
    Sonnet3_5_Interface,
)
...
class LogicalPlanner(LLMStrategy):
    def create_llm_interface(self) -> LLMInterface:
        return Sonnet3_5_Interface(self.llm_logger, self.environment_state_service, self.config)
